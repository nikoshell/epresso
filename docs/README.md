...
- **Content & routes are separate** — `content/` is data (typed collections),
  `pages/` turns that data into URLs.
- **Deterministic + incremental** — content digests drive a build graph so edits
